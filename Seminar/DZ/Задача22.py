...
set1 = {int(input('Введите элементы первого множества: ')) for _ in range(n)}
set2 = {int(input('Введите элементы второго множества: ')) for _ in range(m)}
list1 = sorted(set1.intersection(set2))
print(*list1)
