...
# времени сбора на них выросло различное число ягод — на i-ом кусте
...
# ягоды с этого куста и с двух соседних с ним. Напишите программу для
# нахождения максимального числа ягод, которое может собрать за один
# заход собирающий модуль, находясь перед некоторым кустом заданной во входном файле грядки
# 4 -> 1 2 3 4
# 9

n = int(input('Введите кол-во кустов: '))
list1 = [int(input('Введите кол-во ягод на кустах: ')) for _ in range(n)]
max_number = 0
for i in range(len(list1)):
    berries = list1[i] + list1[i-1] + list1[i-2]
